...
function sumValues($arr, $arrayNumber)
{
    ...
    // (eg278 2/23/26)
    // 1. Loop through the array and add the values to $total.
    // 2. After adding, put the total to exactly two decimal places.
    // 3. Put the new total format value in $modifiedTotal to be displayed.
